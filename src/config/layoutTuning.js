(function (global) {
  ...
  config.LayoutTuning = {
    ...
    /**
     * Масштаб спрайта иконки дрона в модалке «Модификации танков и стен».
     * Изолированно от остальных иконок (оружие, стены).
     * 1 = оригинальный размер, 1.5 = увеличение в 1.5 раза и т.д.
     */
    droneIconScale: 0.7,
