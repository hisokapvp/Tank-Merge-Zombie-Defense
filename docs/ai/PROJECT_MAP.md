...
| `index.html` обязан подключать `src/ui/fontFloor.js`; модуль держит глобальный floor `10px` для DOM и canvas-текста, но DOM observer обязан помечать собственные `style`-мутации, чтобы не пересоздавать очередь на своих же clamp/restore записях, и восстанавливать исходный inline `font-size`/priority, когда элемент выходит в skip-path. | [index.html](../../index.html#L632), [src/ui/fontFloor.js](../../src/ui/fontFloor.js#L4-L8), [src/ui/fontFloor.js](../../src/ui/fontFloor.js#L61-L117), [src/ui/fontFloor.js](../../src/ui/fontFloor.js#L133-L219) |
...
| `Game.FontFloor` | [src/ui/fontFloor.js](../../src/ui/fontFloor.js#L18-L231) | 18–231 | Глобальный floor `10px` для canvas/DOM текста; DOM path хранит original inline font state, восстанавливает его на skip и игнорирует собственные observer-triggered `style`-мутации |
