...
- Auto-merge в модалке подземного ангара использует отдельный runtime путь: [getUndergroundHangarAutoMergeButtonModel()](../../../game.js#L3905-L3955) и [runUndergroundHangarAutoMergeClick()](../../../game.js#L3967-L3986) собирают пары танков одновременно из `state.cells` и `state.undergroundHangar.cells`, не трогают дронов и больше не блокируют underground-кнопку общим `isAutoMergeBusy/cooldown` после первого клика.
- Правая колонка действий в модалке центрируется по вертикали; canonical bulk-buy и auto-merge кнопки показываются только через runtime-модели unlock/visibility из [game.js](../../../game.js), а не через локальные ad-hoc флаги UI. Для bulk-buy label и count canonical source — [getUndergroundHangarBulkBuyButtonModel()](../../../game.js#L1069-L1085), а не локальный `xDisplay`-placeholder.
...
- Для underground hangar синхронно поддерживать `ughBuyTank`, `ughHelpButton`, `ughHelpText` и dynamic auto-merge copy `autoMergeDynamicShort` в `ru.json`, `en.json` и `fallbackStrings.js`: [src/i18n/ru.json](../../../src/i18n/ru.json#L173-L176), [src/i18n/ru.json](../../../src/i18n/ru.json#L565-L573), [src/i18n/en.json](../../../src/i18n/en.json#L173-L176), [src/i18n/en.json](../../../src/i18n/en.json#L565-L573), [src/i18n/fallbackStrings.js](../../../src/i18n/fallbackStrings.js#L134-L140), [src/i18n/fallbackStrings.js](../../../src/i18n/fallbackStrings.js#L351-L358), [src/i18n/fallbackStrings.js](../../../src/i18n/fallbackStrings.js#L506-L512), [src/i18n/fallbackStrings.js](../../../src/i18n/fallbackStrings.js#L735-L742).
- Для UI-правок мастерской и production storage синхронно поддерживать ключи `workshopTabChipRecycle`, `workshopTabChipReprogram`, `chipCraftDisassembleOverlayHint`, `chipRecycleConfirm*`, `chipReprogram*` и `plStorageTitle` в `ru.json`, `en.json` и `fallbackStrings.js`: [src/i18n/ru.json](../../../src/i18n/ru.json#L401-L438), [src/i18n/en.json](../../../src/i18n/en.json#L401-L438), [src/i18n/fallbackStrings.js](../../../src/i18n/fallbackStrings.js#L236-L267), [src/i18n/fallbackStrings.js](../../../src/i18n/fallbackStrings.js#L534-L584).
