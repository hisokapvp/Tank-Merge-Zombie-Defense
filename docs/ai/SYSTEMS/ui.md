...
## Runtime font floor
- `index.html` подключает [src/ui/fontFloor.js](../../../src/ui/fontFloor.js#L1-L133) как отдельный runtime-слой: [index.html](../../../index.html#L632).
- `Game.FontFloor` патчит и `CanvasRenderingContext2D.font`, и DOM через `MutationObserver`, поднимая всё ниже `10px` до `10px`: [src/ui/fontFloor.js](../../../src/ui/fontFloor.js#L23-L133).
