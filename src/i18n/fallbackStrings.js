(function (global) {
  ...
  var STRINGS = {
    ru: {
      ...
      feedbackValidationMessageRequired: 'Добавьте сообщение перед отправкой.',
      feedbackSuccess: 'Спасибо! Отзыв сохранён.',
      feedbackCategoryGeneral: 'Общее',
      feedbackCategoryBug: 'Баг',
      feedbackCategoryBalance: 'Баланс',
      feedbackCategoryUi: 'Интерфейс',
    ...
    en: {
      ...
      feedbackSend: 'Send',
      feedbackValidationMessageRequired: 'Please add a message before sending.',
      feedbackSuccess: 'Thanks! Feedback saved.',
      feedbackCategoryGeneral: 'General',
      feedbackCategoryBug: 'Bug',
      feedbackCategoryBalance: 'Balance',
      feedbackCategoryUi: 'UI',
