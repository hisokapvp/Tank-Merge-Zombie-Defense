...
|----|--------------|--------------------------------------------------------------------------|
| 1  | Двойной      | +1 снаряд на дуло                                                       |
| 2  | Цепная молния| Цепной прыжок к 2 целям, 70% dmg, радиус 84px                           |
| 3  | Матрёшка     | При попадании спавнит child-снаряд (base dmg)                            |
| 4  | Толкание     | Отталкивает зомби (`z.r += 10px`) + 0.5× бонус-урон                     |
| 5  | Притягивание | Притягивает зомби (`z.r -= 10px`) + 0.5× бонус-урон                     |
