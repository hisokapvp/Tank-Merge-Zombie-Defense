...
| Close-кнопки `productionLineStorage` / root supercomputer / hangar / tank-wall / `talentOverlay` используют единый 44×44 паттерн `scModal__close`; talent tree получает класс runtime через `applySharedTalentModalClass()`, а склад коробок дополнительно обязан включать `body.pl-storage-open`, чтобы получить тот же CRT/grain overlay, что и SC-модалки. | [index.html](../../index.html#L214-L217), [index.html](../../index.html#L233-L309), [src/ui/productionLineUI.js](../../src/ui/productionLineUI.js#L44-L61), [src/ui/supercomputerMenu.js](../../src/ui/supercomputerMenu.js#L193-L203), [style.css](../../style.css#L54-L68), [style.css](../../style.css#L1359-L1393), [style.css](../../style.css#L1828-L1920) |
