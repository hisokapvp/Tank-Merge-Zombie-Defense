...
- Merge popup нового уровня танка: локально отключён только right-side hull shot FX через опцию preview renderer; остальные popup FX/SFX и gameplay-эффекты не затронуты.
