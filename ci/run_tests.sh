...
run_test "Pack 6 (projectile destination + impact AoE)" "Test/pack6/projectileAimFallback.test.js"
...
run_test "Pack 8 (chip effect visual toggle)" "Test/pack8/chipEffectVisualToggle.test.js"
...
run_test "Pack 12 (player fragment persistence)" "Test/pack12/playerFragmentsPersistence.test.js"
