...
- Auto-merge в модалке подземного ангара использует отдельный runtime путь: [getUndergroundHangarAutoMergeButtonModel()](../../../game.js#L3905-L3946) и [runUndergroundHangarAutoMergeClick()](../../../game.js#L3948-L3974) собирают пары танков одновременно из `state.cells` и `state.undergroundHangar.cells`, но не трогают дронов.
